...
- 本轮小窗口修复前 HEAD：`bc5835a4b6 feat: 增加富媒体运行时开关`
...
- LaTeX 的真实 WezTerm 公式显示、运行时开关和复制语义已执行；小窗口裁切的代码修复与自动化回归已完成，公式专项 resize、滚动与任务切换仍待新二进制视觉确认；
